 ...
 * @author Hani
 */
public class searchDList extends JFrame {

    JLabel Enter = new JLabel("Enter id of Doctor : ");
JLabel j ;
    ...
    public class ButtonWatcher implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (buttonPressed.equals(search)) {
                ...
                JOptionPane.showMessageDialog(null, listofDoc.get(y), "list ", JOptionPane.WARNING_MESSAGE);
                JFrame jf = new JFrame();
                setLayout(null);
                j=new JLabel(listofDoc.get(y).getGender());
